...
while($row=mysqli_fetch_array($query)){
    ...
    ?>
                ...
                <table>
                <tr><th>date du mise circulation:</th>
    ...
    ?> </td></tr></table>
          ...
          <a href="modifierresponsable.php" target="_blank"><input type="button" value="modifier"  ></a>
    <a href="supprimerresponsable.php" target="_blank"><input type="button" value="supprimer"  ></a>
   </div></form></div>
        </body>
    </html>