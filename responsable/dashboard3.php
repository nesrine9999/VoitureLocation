...
<form  action="rechercherrecue.php"method="POST">
    <br>
<div class="main"  >
    <div id="responsable"><h1 style="color:red">recues</h1>
    <p style="color:white; "> Rechercher_recue:  </p>
          
   <h5 style="color:white">id_payement <input type="text" name="id"></h5>
    
   <input type="submit" value="rechercher"  ></div></div></form>
    <br>
    <br>
    <br>   <form action="consulterrecue.php" method="POST">
    <div class="main"  >
    <div id="responsable">
    <p><h4  style="color:white "> consulter_les_recues</h4> </p>
        
  <input type="submit" value="consulter"  ></a></form>
    <br>
    <br>
    <br><form method="POST" action="ajouterrecue.php">
   <p style="color:white"><b> ajouter_une_recue_cliquer_sur_ce_lien</b> </p>
