						...
						<div class="form-group">
							<label for="password">Password</label>
								<div class="input-group">
									...
									<input type="password" class="form-control" name="pwd" placeholder="<?php
include"config.php";
$_post['password']="select pwd from responsable where cin=1" ;
?>"/>
								</div>
						</div>
				...
				<input type="text" class="form-control" name="adresse"  placeholder="Entrer votre adresse"/>
                        ...
                        <div class="form-group">
							<label for="role">Role</label>
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                                    <select > <option>Chef</option>  <option>Controleur</option> <option></option></select>
