...
<form method="POST" action="modifierresponsable.php">
<div class="main"  >
<?php
...
$req = "select * from responsable where cin=$cine";
...
while($row=mysqli_fetch_array($query)){
   ...
   <form action="supprimerresponsable.php" method="POST"><input type="submit" value="supprimer"  >
   </div></form></div>
                    </td></tr></table>
                    </td></tr></table>
                    </td></tr></table>
